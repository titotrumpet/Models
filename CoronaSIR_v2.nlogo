...
to guérir_ou_perir                             ;;  routine per cada personne
  ...
  if temps_malade > durée_infection
    [ifelse random-float 100 > %mortalité
      [guerison]
...
"morts" 1.0 0 -7500403 true "" "plot N_morts / count turtles * 100"
"confines" 1.0 0 -955883 true "" "if confinement [plot-pen-up plotxy ticks 0 plot-pen-down plotxy ticks plot-y-max ]"
